          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li><Link href="#" className="text-sm hover:text-white">자주 묻는 질문</Link></li>
                <li><Link href="#" className="text-sm hover:text-white">문의하기</Link></li>
                <li><Link href="#" className="text-sm hover:text-white">이용약관</Link></li>
                <li><Link href="#" className="text-sm hover:text-white">개인정보처리방침</Link></li>
              </ul>
            </div>
