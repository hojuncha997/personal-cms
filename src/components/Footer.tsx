        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm hover:text-white">자주 묻는 질문</a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-white">문의하기</a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-white">이용약관</a>
              </li>
              <li>
                <a href="#" className="text-sm hover:text-white">개인정보처리방침</a>
              </li>
            </ul>
          </div>
