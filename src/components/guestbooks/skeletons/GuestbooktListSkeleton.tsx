// 방명록 목록 스켈레톤
// src/components/guestbooks/skeletons/GuestbooktListSkeleton.tsx

import { Container } from '@/components/layouts/Container';
import { colors } from '@/constants/styles/colors';

const GuestbookItemSkeleton = () => (
...
export default GuestbookListSkeleton; 