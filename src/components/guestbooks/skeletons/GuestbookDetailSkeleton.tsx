...
const GuestbookContentSkeleton = () => (
...
const RelatedGuestbookItemSkeleton = () => (
                        ...
                        <div className="bg-white shadow-md">
                            <div className="p-4 sm:p-6">
                                <div className="space-y-3">
                                    {[...Array(3)].map((_, i) => (
                                        <RelatedGuestbookItemSkeleton key={i} />
                                    ))}
                                </div>
                            </div>
                        </div>
...
export default GuestbookDetailSkeleton; 