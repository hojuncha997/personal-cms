...
import { useGetGuestbookCategories, type GuestbookCategory } from '@/hooks/guestbooks/useGetGuestbookCategories';
...
interface GuestbookFormProps {
    ...
    onSubmit: (data: GuestbookData) => Promise<void>;
    onCancel: () => void;
}
...
export const GuestbookForm: React.FC<GuestbookFormProps> = ({
    ...
    const { data: categories, isLoading: isCategoriesLoading } = useGetGuestbookCategories();
    ...
    const renderCategoryOptions = (categories: GuestbookCategory[] = [], depth = 0) => {
