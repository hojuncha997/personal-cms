...
import { useGetProjectCategories, type ProjectCategory } from '@/hooks/projects/useGetProjectCategories';
...
export const ProjectForm: React.FC<ProjectFormProps> = ({
    ...
    const { data: categories, isLoading: isCategoriesLoading } = useGetProjectCategories();
    ...
    const renderCategoryOptions = (categories: ProjectCategory[] = [], depth = 0) => {
